...
(defparameter *scale-types* (list (cons 'mercator (find-class 'mercator))
                                (cons 'albers (find-class 'albers))
                                (cons 'albers-usa (find-class 'albers-usa))
                                (cons 'equi-rectangular (find-class 'equi-rectangular))
                                (cons 'orthographic (find-class 'orthographic))
                                (cons 'gnomonic (find-class 'gnomonic))
                                (cons 'stereographic (find-class 'stereographic))
                                (cons 'linear-scale (find-class 'linear-scale))
                                (cons 'log-scale (find-class 'log-scale))
                                (cons 'date-scale (find-class 'date-scale))
                                (cons 'ordinal-scale (find-class 'ordinal-scale))
                                (cons 'color-scale (find-class 'color-scale))
                                (cons 'date-color-scale (find-class 'date-color-scale))
                                (cons 'ordinal-color-scale (find-class 'ordinal-color-scale))))  
